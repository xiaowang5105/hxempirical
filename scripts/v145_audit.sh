#!/usr/bin/env bash
set -euo pipefail
python3 scripts/v145_patch.py

rm -rf /tmp/sfi /tmp/classes audit-v145
mkdir -p /tmp/sfi/com/stata/sfi /tmp/classes audit-v145
...
grep -q 'VERSION = "1.4.5"' src/main/java/com/hexie/stata/HxWorkbench.java
