...
- 如果本次更新包含 Java 工作台/JAR 变化，安装完成后请**彻底退出 Stata 再重新打开**，避免当前会话继续使用旧 Java 类。
...
> 说明：以下旧记录保留当时版本的历史行为；当前安装、更新和第三方命令策略以上方“安装与日常更新”“第三方命令”章节为准。
...
- 在最新版主线保留 OneClick、新数据表、外部命令扫描及相邻 JAR 加载功能。
