...
测试范围与剩余限制见 [1.6.3 验证记录](docs/VALIDATION-1.6.3.md)和[研究项目说明](docs/PROJECTS.md)。
...
- **项目 ZIP**：打包项目、模型和可识别的本地数据依赖，提供相对路径 replay.do、文件校验清单和创建项目时的 Stata 环境信息。解压后切换到解压目录运行；1.6.3 更新了路径迁移与拒绝规则，详见研究项目说明。
...
1.6.3 的验证环境为 Windows / StataNow 19.5 MP。真实 Stata、Java 与发布检查的具体结果见[验证记录](docs/VALIDATION-1.6.3.md)，1.6.0 的测试记录[另行保留](docs/VALIDATION-1.6.0.md)。当前分支的远端检查及网页部署状态见 [GitHub Actions](https://github.com/xiaowang5105/hxempirical/actions)。Stata 17/18 与 macOS 尚未在本次环境中实测。
