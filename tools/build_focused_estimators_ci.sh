...
# Static contract checks for this batch.
grep -Fq '*! hxsemantics 1.3.2  12aug2026' hxsemantics.ado
grep -Fq 'local default_model "随机效应（RE）"' hxsemantics.ado
grep -Fq '*! hxresolve 3.1.2  12aug2026' hxresolve.ado
grep -Fq 'local has_weight 1' hxresolve.ado
grep -Fq 'configureGenericWeightTypes()' src/main/java/com/hexie/stata/HxWorkbench.java
grep -Fq 'validateFocusedEstimationBeforeRun()' src/main/java/com/hexie/stata/HxWorkbench.java
grep -Fq 'Arrays.asList("无", "fweight", "pweight")' src/main/java/com/hexie/stata/HxWorkbench.java
grep -Fq 'Arrays.asList("无", "fweight", "aweight", "pweight")' src/main/java/com/hexie/stata/HxWorkbench.java
...
echo "HX_FOCUSED_ESTIMATOR_BUILD_OK classes=$class_count"
