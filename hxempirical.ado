...
program define hxempirical, rclass
    ...
    if `"`action'"' == "about" {
        ...
        display as text ustrunescape("\u7248\u672c\uff1a") as result "1.6.3"
    ...
    if `"`action'"' == "doctor" {
        local core "hxtoolbox hxmenu hxsetup hxregistry hxresolve hxexecute hxmonitor hxrefresh hxpick hxcontext hxproject"
        local core_total 13
        local core_ok 0
        local core_missing ""
